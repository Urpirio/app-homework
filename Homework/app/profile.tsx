      ...
      <ThemedView style={styles.container}>
              ...
              <Animated.View entering={FadeInDown.duration(500)}>
                ...
                >
                  ...
                  <View style={styles.avatarWrapper}>
                    <View
                      style={[styles.avatarRing, { borderColor: roleColor }]}
                    >
                      {user?.avatarUrl ? (
                        <Image
                          source={{ uri: getFullUrl(user.avatarUrl) }}
                          style={styles.avatar}
                        />
                      ) : (
                        <View
                        ...
                        >
                          <Text
                            style={[styles.avatarInitial, { color: roleColor }]}
                          >
        ...
        >
          ...
          >
            <Animated.View
              entering={FadeInDown}
              style={[styles.qrCard, { backgroundColor: theme.colors.card }]}
            >
              ...
              <Text style={[styles.qrName, { color: theme.colors.text }]}>
                {user?.fullName}
              </Text>
              <Text
                style={[styles.qrHint, { color: theme.colors.textSecondary }]}
              >
              ...
              >
                <Text style={[styles.qrCodeText, { color: roleColor }]}>
                  {user?.identityCode}
                </Text>
                <Ionicons
                  name="copy-outline"
...
const InfoChip = ({ icon, label, value, theme, fullWidth }: any) => (
  ...
  >
    ...
    />
    <Text style={[styles.infoChipLabel, { color: theme.colors.textSecondary }]}>
      {label}
    </Text>
    <Text
      style={[styles.infoChipValue, { color: theme.colors.text }]}
      numberOfLines={3}
    >
      {value}
    </Text>
...
const styles = StyleSheet.create({
  ...
  avatarInitial: { fontSize: 38, fontWeight: "900", textAlign: "center" },
  onlineDot: {
    position: "absolute",
    bottom: 4,
    right: 4,
  ...
  userName: { fontSize: 22, fontWeight: "900", marginBottom: 4,textAlign:"center" },
