        ...
        <FlatList
          ...
          renderItem={({ item, index }) => (
            ...
            >
              ...
              >
                <View style={[styles.bookCover, { backgroundColor: item.color + '10' }]}>
                  <Ionicons name={item.cover as any} size={50} color={item.color} />
                  {!item.available && (
                ...
                <View style={styles.bookInfo}>
                  ...
                  <View style={styles.bookFooter}>
                    <Text style={[styles.bookCategory, { color: item.color }]}>{item.category}</Text>
                    <Ionicons 
